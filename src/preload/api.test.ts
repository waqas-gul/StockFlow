...
describe('createApi (the preload bridge)', () => {
  it('exposes exactly one function per contract call, grouped by domain', () => {
    ...
    expect(exposed).toEqual([
      ...
      'suppliers:get:function',
      'suppliers:create:function',
      'suppliers:update:function',
      'suppliers:setActive:function',
      'suppliers:ledger:function',
      'suppliers:adjustBalance:function',
      'suppliers:search:function',
      'supplierPayments:list:function',
      'supplierPayments:get:function',
      'supplierPayments:create:function',
      'supplierPayments:checkDuplicate:function',
      'supplierPayments:void:function',
      ...
      'reports:supplierBalances:function',
